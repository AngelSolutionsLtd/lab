        ...
        <div class="row no-gutters w-100">
                ...
                <ol class="nav pagination v-pagination v-zeta">
                    <li class="pagination-item pagination__first flush--left">
                        <a
                            ...
                            :class="{ 'inactive': isInFirstPage || loading }"
                        >
                            First
                        </a>
                    </li>
                    ...
                    <template v-if="enhancedMode">
                        <li class="pagination-item pagination__input">
                            <input
                                ...
                                inputmode="numeric"
                                pattern="[0-9]*"
                                @keyup.enter="pageEnterPressed"
                                @keypress="onlyNumber"
                                :maxlength="maxLength"
                                :class="{ 'inactive': totalPages == 1 || loading }"
                            />
                        </li>

                        <li class="pagination-item pagination__label">
                            <div class="page-count" v-if="totalPages > 0">
                        ...
                        <li class="pagination-item pagination__submit">
                            <button
                                class="btn btn--inverted btn--natural"
                    ...
                    <template v-else>
                        ...
                        >
                            <a
                                ...
                                :class="{ 'active': isPageActive(page.name), 'inactive': page.isDisabled || loading }"
                    ...
                    <li class="pagination-item pagination__next">
                        <a
                            ...
                            :class="{ 'inactive': isInLastPage || loading }"
            ...
            <div v-if="enhancedMode" class="col-12 col-md-6 col-lg-4">
                ...
                <div class="row-picker-wrapper form-fields v-zeta text-left text-md-right">
                    <template v-if="enhancedMode">
                        <label for="row-picker" class="row-picker__label"
                            >Rows per page</label
                        >
                        <select
                            v-model="rowsPerPage"
...
const startPage = computed(() => {
    ...
    if (props.currentPage === props.totalPages) {
        let pageNum = props.totalPages - (props.maxVisibleButtons - 1);
        if (pageNum < 1) {
            pageNum = 1;
        }
        return pageNum;
...
const pageEnterPressed = () => {
    if (enterPageValue.value) {
        enterPageValue.value.click();
    }
};
